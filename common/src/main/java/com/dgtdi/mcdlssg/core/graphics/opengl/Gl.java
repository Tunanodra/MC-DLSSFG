...
import com.dgtdi.mcdlssg.core.graphics.opengl.dsa.CompatDirectStateAccessImpl;
import com.dgtdi.mcdlssg.core.graphics.opengl.dsa.GL45OrEXTDirectStateAccessImpl;
import com.dgtdi.mcdlssg.core.graphics.opengl.dsa.IGlDirectStateAccess;
...
public class Gl {
    ...
    static {
        if (!isSupportDSA()) {
            MCDLSSG.LOGGER.info("不支持DSA 使用 CompatDirectStateAccessImpl");
            DSA = new CompatDirectStateAccessImpl();
        } else {
            MCDLSSG.LOGGER.info("支持DSA 使用 GL45OrEXTDirectStateAccessImpl");
